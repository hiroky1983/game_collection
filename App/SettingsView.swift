                ...
                if let playLog {
                    Section {
                        ...
                        .confirmationDialog(
                            ...
                            Text("ベストスコア・最短タイム・勝敗と連勝の記録、遊んだ回数・勝った回数、おすすめや評価のお願いの表示履歴を消します。元に戻せません。")
                        }
                    } header: {
                        Text("プレイ記録")
                    } footer: {
                        Text("あそびごとのベストスコア・最短タイム・勝敗と連勝を、遊んだ回数・勝った回数・遊んだあそびの種類・おすすめと評価のお願いの表示履歴とあわせてこの端末に保存しています（送信はしません）。盤面や棋譜は残していません。")
                    }
                }
