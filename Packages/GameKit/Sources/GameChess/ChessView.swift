...
public struct ChessView: View {
    ...
    private var gameControls: some View {
        ...
        BoardGameControlBar(
            model: model, services: services, rescue: undoRescue, hint: BoardControlBarHint(model, game: model.gameSerial, activity: [model.moves.count, model.selectedSquare ?? -1]),
