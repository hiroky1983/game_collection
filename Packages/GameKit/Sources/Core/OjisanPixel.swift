...
public enum OjisanPixel {
    ...
    // smile 32x30（#1349）。粗い版の 2×2 複製ではなく描き直し: 輪郭 `K` は 1 ドット幅、階段は 1 ドット刻みの曲線に。
    // 髪は元の比率（頭頂で髪:地肌:髪 = 1:1:1）を保ち `W` で白髪の粒を足した。目は 4×3 で下端を丸め、鼻は鉤形、頬は 3×2。
    static let smileRows: [String] = [
        "...........KKKKKKKKKKKK.........",
        ".........KKHHhhSSSShhHHKK.......",
        ".......KKHWHhhSSSSSShhHWHKK.....",
        "......KHWHhhSSSSSSSSSShhHWHK....",
        ".....KHHhhSSSSSSSSSSSSSShhHHK...",
        "....KWHhhSSSSSSSSSSSSSSSShhHWK..",
        "...KHHhSSSSSSSSSSSSSSSSSSSShHHK.",
        "...KHhhSSSSSSSSSSSSSSSSSSSShhHK.",
        "..KHHhhSShhhhSSSSSSSShhhhSShhHHK",
        "..KHWhhShhhhhSSSSSSSShhhhhShhWHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KhhSSSSSQESSSSSsSSSSQESSSSShhK",
        "..KhhSSSSSSSSSSsssSSSSSSSSSSShhK",
        "..KssSSSCCCSSSSSSSSSSSCCCSSSSssK",
        "..KssSSSCCCSSSSSSSSSSSCCCSSSSssK",
        "..KssSSSSSShhhhHHHHhhhhSSSSSSssK",
        "..KssSSSSShhhhhHHHHhhhhhSSSSSssK",
        "...KssSSSSShhMMMMMMMMhhSSSSSssK.",
        "....KssSSSShMMMMMMMMMMhSSSSssK..",
        ".....KssSSSSMQQQQQQQQMSSSSssK...",
        "......KKssSSSMQQQQQQMSSSssKK....",
        "........KssSSSSSSSSSSSSssK......",
        ".........KKsSSSSSSSSSSsKK.......",
        "...........KKsSSSSSSsKK.........",
        ".............KKssssKK...........",
    ...
    // cheer 32x30（#1349）。smile と同じ格子で、口（18〜23 行）だけ大口＋下の歯に差し替え。
    static let cheerRows: [String] = [
        ...
        "..KssSSSSShhhhhHHHHhhhhhSSSSSssK",
        "...KssSSSSShhMMMMMMMMhhSSSSSssK.",
        "....KssSSShMMMMMMMMMMMMhSSSssK..",
        ".....KssSSMMMMMMMMMMMMMMSSssK...",
        "......KKsSMMMMMMMMMMMMMMSsKK....",
        "........KssMQQQQQQQQQQMssK......",
        ".........KKssMMMMMMMMssKK.......",
        "...........KKsSSSSSSsKK.........",
        ".............KKssssKK...........",
    ...
    // frown 32x30（#1349）。smile と同じ格子で、眉（8〜9 行）を内へ下げた怒り眉に、口（18〜21 行）をヒゲの下のへの字に差し替え。
    static let frownRows: [String] = [
        ...
        "...KHHhSSSSSSSSSSSSSSSSSSSShHHK.",
        "...KHhhSSSSSSSSSSSSSSSSSSSShhHK.",
        "..KHHhhSSShhhhSSSSSShhhhSSShhHHK",
        "..KHWhhSSSSShhhhSShhhhSSSSShhWHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KhhSSSSSQESSSSSsSSSSQESSSSShhK",
        "..KhhSSSSSSSSSSsssSSSSSSSSSSShhK",
        ...
        "..KssSSSSSShhhhHHHHhhhhSSSSSSssK",
        "..KssSSSSShhhhhHHHHhhhhhSSSSSssK",
        "...KssSSSSShhhhhhhhhhhhSSSSSssK.",
        "....KssSSShhSMMMMMMMMShhSSSssK..",
        ".....KssSSSMMSSSSSSSSMMSSSssK...",
    ...
    // gaze 32x30（#1349）。smile と同じ格子で、眉（8〜9 行）を八の字に、口（17〜21 行）を小さく開いた丸に差し替え。頬はそのまま。
    static let gazeRows: [String] = [
        ...
        "...KHHhSSSSSSSSSSSSSSSSSSSShHHK.",
        "...KHhhSSSSSSSSSSSSSSSSSSSShhHK.",
        "..KHHhhSSSSShhhhSShhhhSSSSShhHHK",
        "..KHWhhSShhhhSSSSSShhhhSSSShhWHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KHhhSSSQQEESSSSSSSSQQEESSShhHK",
        "..KhhSSSSSQESSSSSsSSSSQESSSSShhK",
        "..KhhSSSSSSSSSSsssSSSSSSSSSSShhK",
        ...
        "..KssSSSCCCSSSSSSSSSSSCCCSSSSssK",
        "..KssSSSSSShhhhHHHHhhhhSSSSSSssK",
        "..KssSSSSSSShhhHHHHhhhSSSSSSSssK",
        "...KssSSSSSSShhMMMMhhSSSSSSSssK.",
        "....KssSSSSSSShMMMMhSSSSSSSssK..",
        ".....KssSSSSSSSMMMMSSSSSSSssK...",
        "......KKssSSSSSSMMSSSSSSssKK....",
        "........KssSSSSSSSSSSSSssK......",
        ".........KKsSSSSSSSSSSsKK.......",
        "...........KKsSSSSSSsKK.........",
        ".............KKssssKK...........",
