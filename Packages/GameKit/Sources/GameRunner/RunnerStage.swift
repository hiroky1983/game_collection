...
public extension RunnerStage {
    ...
    private static let patterns: [String] = [
        ...
        "--1-n-t--d1-2--",           // 4: 15区画・障害6個（岩穴5+犬1）。高い障害物と犬の初出。障害が隣り合う区画の初出（犬→穴）
        "--1sn-tb-2-d-t--",          // 5: 16区画・障害7個（岩穴5+鳥1+犬1）。スピードアップアイテムと飛び立つ鳥の初出
        "--1sn-3-tb-2d-t--",         // 6: 17区画・障害8個（岩穴6+鳥1+犬1）。3 タイル（跳べる最大幅）の穴の初出
        "--1sn-3-t2-i-t-1--",        // 7: 18区画・障害8個（岩穴7+イノシシ1）。イノシシの初出。高い岩の直後に穴（隣り合う区画の難しい組）が出始める
        "--2st-1d-3-t2-n-t--",       // 8: 19区画・障害9個（岩穴8+犬1）
        "--2st1-n-3t-2-it-3--",      // 9: 20区画・障害10個（岩穴9+イノシシ1）。岩の手前のイノシシ（岩で止まる）の初出
        "--2st1-n3-t-2d-t3-2--",     // 10: 21区画・障害11個（岩穴10+犬1）
        "--t2sn3-t1t-2t-3i-tt--",    // 11: 22区画・障害13個（岩穴12+イノシシ1）。平地を挟んだ次が岩なので止まらない（出現点が岩の手前）
        "--t2sn3-t1t-2t3-it-t2--",   // 12: 23区画・障害14個（岩穴13+イノシシ1）。岩で止まる
        "--t2sb3t1-t2t3-btt2-i3--",  // 13: 24区画・障害16個（岩穴13+鳥2+イノシシ1）。夜は鳥とイノシシを混ぜる
        ...
        "--3t-n-PP-PP-==-t3-PPP-t2d--",  // 17: 28区画・障害8個（岩穴7+犬1）＋台座3基＋床2区画（1基）。台座を乗り継ぐ（連続台座）
        "--3t2-b-PP-=-t3-PPP-bt-=-bd--", // 18: 29区画・障害10個（岩穴6+鳥3+犬1）＋台座2基＋床2区画。台座と鳥・岩・犬の複合
    ]
}
