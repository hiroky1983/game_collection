...
public extension RunnerStage {
    ...
    private static let patterns: [String] = [
        ...
        // 5 区画以内の手前に置かない、先頭・末尾の 2 区画は平地）で、面ごとに台座 1 基（2 区画）と
        // 床 1 本（2 区画）を置く。
        //
        // **新しい仕組み 4 つ（#1010 突き上げ・#1089 沈む床・#1090 崩れる足場・#1091 高い塀）は
        // まだ `release/v1.1.6` に無いので、予定の区画を今ある障害で仮に埋めてある**（#1009 本文 D）。
        // 仮置きは 突き上げ・高い塀 → 高い岩 `t`、沈む床 → 2 タイルの穴 `2`、崩れる足場 → 3 タイルの穴 `3`。
        ...
        "--PP-1n-t-2ikt1n==-t2b-ti1t---",           // 19: 30区画・障害15個（穴5+低い岩2+高い岩5+鳥1+イノシシ2）。予定: 竹の子（#1010）= 区画 8・19・26。里山に入った。竹の子を覚える
        "--1nt-2dkt1-PP-nt2itn==-t1b-t--",          // 20: 31区画・障害17個（穴5+低い岩3+高い岩6+鳥1+犬1+イノシシ1）。予定: 竹の子 = 区画 4・16・24・28。切り株（`n`）のすぐ隣に竹の子
        "--1tn-2-2iknt1==-t1d2-b2t-PP-t--",         // 21: 32区画・障害17個（穴7+低い岩2+高い岩5+鳥1+犬1+イノシシ1）。予定: 竹の子 = 区画 12・29 / 田んぼ（#1089）= 区画 6・20。田んぼを覚える
        "--PP-1n2ikt2t-n1d-==-t2i1t2b-t1--",        // 22: 33区画・障害19個（穴8+低い岩2+高い岩5+鳥1+犬1+イノシシ2）。予定: 竹の子 = 区画 12・25 / 田んぼ = 区画 7・22。田んぼの直後にイノシシ
        "--1tn21ikt2tn22d-==-tt1bn2-t-PP---",       // 23: 34区画・障害20個（穴8+低い岩3+高い岩6+鳥1+犬1+イノシシ1）。予定: 竹の子 = 区画 3・11・21・27 / 田んぼ = 区画 5・13・25。田んぼを抜けた直後に用水路
        "--PP-1tn2iktt221dn==-t-3-tt1b2-t---",      // 24: 35区画・障害20個（穴8+低い岩2+高い岩7+鳥1+犬1+イノシシ1）。予定: 竹の子 = 区画 6・12・21・25 / 田んぼ = 区画 8・14・29 / 吊り橋（#1090）= 区画 23 / 石垣（#1091）= 区画 31。里山の締め。全部入り
        "--PP-1n-3-tik2t1==-t2-31ti-PP-d2-b--",     // 25: 36区画・障害17個（穴8+低い岩1+高い岩4+鳥1+犬1+イノシシ2）。予定: 古い桟橋（#1090）= 区画 8・22。港町に入った。桟橋の先が切れ目
        "--132dk-t-n-PP-t31i-==-tn2b-32ti-PP--",    // 26: 37区画・障害18個（穴8+低い岩2+高い岩4+鳥1+犬1+イノシシ2）。予定: 波しぶき（#1010）= 区画 8・23 / 古い桟橋 = 区画 3・16・28
        "--PP-1n-t-2ikt31-t-==-2dn32tb-t-1it---",   // 27: 38区画・障害20個（穴8+低い岩2+高い岩6+鳥1+犬1+イノシシ2）。予定: 古い桟橋 = 区画 14・25 / コンテナ（#1091）= 区画 8・30。二段ジャンプを覚える
        "--1t-32iktt1-t-d31t-==-tn2b-t-32ti-PP--",  // 28: 39区画・障害22個（穴9+低い岩1+高い岩8+鳥1+犬1+イノシシ2）。予定: 波しぶき = 区画 10・23 / 古い桟橋 = 区画 5・16・30 / コンテナ = 区画 3・13・28
        "--PP--2-t2iktt-1n2it-==-t2b-t-21ttnd2---", // 29: 40区画・障害22個（穴8+低い岩2+高い岩8+鳥1+犬1+イノシシ2）。予定: 波しぶき = 区画 8・24・33 / 干潟（#1089）= 区画 6・17・30 / コンテナ = 区画 13・28。里山で覚えた仕組みの港版
        "--PP-1tn2ikt32t-dt1-==-t2itt-32b-tn21t---", // 30: 41区画・障害25個（穴10+低い岩2+高い岩9+鳥1+犬1+イノシシ2）。予定: 波しぶき = 区画 6・17・33 / 干潟 = 区画 8・24・35 / 古い桟橋 = 区画 12・29 / コンテナ = 区画 14・27・37。港町の締め。全部入り
    ]
}
