...
public extension RunnerStage {
    ...
    private static let patterns: [String] = [
        ...
        "--t2sb3t1-t2t3-btt2-n3--",  // 13: 24区画・障害16個（岩穴14+鳥2）。1 面に鳥 2 羽の初出
...
public extension RunnerStage {
    ...
    ///
    /// 鳥（`b`）を入れてあるのは、本番では 5・6 面と 13〜15・18 面にしか出ないので**くぐる挙動（#671）を
    /// 確かめるのに 5 面まで遊ぶ必要がある**ため。跳ばずに走り抜けるところは
