...
public enum RunnerRules {
    ...
    ///
    /// 高い塀（`RunnerHazardKind.wallTop` = 20）はこれより低く、`jumpApex` より高い——
    ...
    /// 降りきるまでに進む距離（`doubleJumpRange(at: 57.2)` ≒ 97.6）を区画（64）に切り上げた
...
public extension RunnerStage {
    ...
    private static let patterns: [String] = [
        ...
        "--PP-1n2t-2ik-C-w--==-2d-C-tb1t-1i-w--",   // 27: 38区画・障害16個（穴6+低い岩1+高い岩3+鳥1+犬1+イノシシ2+コンテナ2）＋古い桟橋 2（区画 14・25。#1090）。二段ジャンプを覚える（コンテナ = 区画 16・35。#1091）
        ...
        "--PP--~-^2ik-w--n~it1==-^2b2t-~1t^nd-w--", // 29: 40区画・障害19個（穴5+低い岩2+高い岩3+鳥1+犬1+イノシシ2+波しぶき3+コンテナ2）＋短い干潟 3（区画 6・17・30。#1089）＋コンテナ 2（区画 13・37。#1091）。里山で覚えた仕組みの港版（区画 6 は前後を素の平地にして単独で見せる）
        "--PP-1^n~ik-C-w--^1d==-t~itt-C-b1^n~1-w--", // 30: 41区画・障害18個（穴4+低い岩2+高い岩3+鳥1+犬1+イノシシ2+波しぶき3+コンテナ2）＋短い干潟 3（区画 8・24・35）＋古い桟橋 2（区画 12・29。#1090）＋コンテナ 2（区画 14・38。#1091）。港町の締め。全部入り
    ]
}
