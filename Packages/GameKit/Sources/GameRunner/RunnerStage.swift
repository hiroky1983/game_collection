...
public extension RunnerStage {
    ...
    /// およそ半分（#987 で 1/3 から上げた）から最終面の 8 割強まで増える。どちらも `RunnerStageTests` が
    ...
    private static let patterns: [String] = [
        ...
        "--1-n-t--d1k2--",          // 4: 15区画・障害6個（岩穴5+犬1）。高い障害物と犬の初出。動く障害が隣に並ぶ初出（犬→穴。障害どうしが隣り合うこと自体は #987 で 1 面から出る）。たこ焼きの初出（犬の後ろ）
