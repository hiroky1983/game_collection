...
public extension RunnerWorld {
    ...
    enum DressingPalette {
        ...
        /// 用水路の水（0x2C4A5A）・海（0x2E5C74）とも、里山の空・丘とも 3:1 以上。
        public static let crumbleDeck: UInt32 = 0xD8C49A
        /// 板の木目・板と板の継ぎ目。板と 3:1 以上で、抜け落ちる 1 枚の境目が読める暗さ。
        public static let crumbleDeckSeam: UInt32 = 0x6B5233
        /// 吊り橋の縄（主索と吊り索）。板より暗く、谷の水よりは明るい。
        public static let crumbleRope: UInt32 = 0x9A7B4F
        /// 桟橋の杭と、吊り橋の袂の柱。縄より暗い、濡れた木の色。
        public static let crumblePost: UInt32 = 0x4E3B27
        /// 崩れる予告のひび（揺れているあいだ板の上に出る）。板と 3:1 以上。
