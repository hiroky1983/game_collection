...
import { APP_STORE_URL, SITE_NAME, SITE_URL } from "./lib/site";
...
const defaultDescription = `${gameCount}種類のゲーム（${releasedGames.map((g) => g.name).join("・")}）を1本にまとめた iPhone 用ゲームコレクション。すべてオフラインで遊べて、通信も会員登録も不要。無料。`;
